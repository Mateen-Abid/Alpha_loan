...
from apps.core.views.superadmin_dashboard import (
    ...
    superadmin_dashboard_send_email,
)
from apps.core.views.row_lookup import (
    ...
    row_lookup_generate_email_message,
    row_lookup_send_sms,
    row_lookup_send_email,
    row_lookup_run_ingestion,
)
...
urlpatterns = [
    ...
    path('admin/superadmin-dashboard/send-email/', superadmin_dashboard_send_email, name='superadmin_dashboard_send_email'),
    ...
    path('admin/row-lookup/generate-email-message/', row_lookup_generate_email_message, name='row_lookup_generate_email_message'),
    path('admin/row-lookup/send-sms/', row_lookup_send_sms, name='row_lookup_send_sms'),
    path('admin/row-lookup/send-email/', row_lookup_send_email, name='row_lookup_send_email'),
    path('admin/row-lookup/run-ingestion/', row_lookup_run_ingestion, name='row_lookup_run_ingestion'),
